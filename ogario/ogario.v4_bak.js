...
*/
        ...
        sendSpawn2(temp) {
            ...
            if (document.getElementById('userStatus').innerText == 'Connected' && window.RequestedTokens > 1) {
				...
				$('#captchatokens2').html(parseInt($('#captchatokens2').html())+1);
                //setTimeout(function() {
                legendmod.sendTokenForBots();
                //}, 100);
