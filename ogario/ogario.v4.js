...
window.connectionBots = {
    ...
    onopen() {
		...
		document.getElementById('userStatus2').style.color = '#00C02E'
        document.getElementById('userStatus2').innerText = 'Connected'
        document.getElementById('connectBots2').disabled = true
        document.getElementById('startBots').disabled = false
        document.getElementById('startBots2').disabled = false
        document.getElementById('captchaBots').disabled = false
        document.getElementById('stopBots').disabled = false
        document.getElementById('stopBots2').disabled = false
    ...
    onmessage(message) {
        ...
        switch (dataView.getUint8(0)) {
            case 0:
                ...
                document.getElementById('startBots2').disabled = true
                document.getElementById('captchaBots').disabled = false
                //document.getElementById('connectBots2').disabled = false
                ...
                document.getElementById('stopBots2').disabled = false
                document.getElementById('startBots2').style.display = 'none'
                document.getElementById('stopBots2').style.display = 'inline'
            ...
            case 1:
				...
				document.getElementById('stopBots2').disabled = true
                document.getElementById('stopBots2').innerText = 'Stopping..'
                break
            case 2:
                ...
                document.getElementById('startBots2').style.display = 'inline'
                document.getElementById('stopBots').style.display = 'none'
                document.getElementById('stopBots').innerText = 'Stop Bots'
                document.getElementById('stopBots2').style.display = 'none'
                document.getElementById('stopBots2').innerText = 'stopBots'
            ...
            case 4:
                ...
                $('#botCount2').html(`${dataView.getUint8(2)}`)
                break
            case 5:
    ...
    onclose() {
        ...
        document.getElementById('botsAI').style.color = '#DA0A00'
        document.getElementById('botsAI').innerText = 'Disabled'
        document.getElementById('userStatus2').style.color = '#DA0A00'
        document.getElementById('userStatus2').innerText = 'Disconnected'
        document.getElementById('botsAI2').style.color = '#DA0A00'
        document.getElementById('botsAI2').innerText = 'Disabled'
		document.getElementById('connectBots2').disabled = false
    ...
    var application = window.application = {
        ...
        */
        ...
        setMenu() {
				...
				'<a id= "LegendClanDiscord" href="https://discord.com/invite/CbMkY77" target="_blank" class="fa fa-globe" data-toggle="tab-tooltip" data-container="body" data-placement="left" title="" data-original-title="Legend clan Discord"></a></div>');				
                ...
                $(".left-container").append(`<div id="quick-bots" class="agario-panel agario-side-panel"><h2 id="botsInfo"></h2>									
					...
					<u><a href="https://repl.it/@affanfals/party-bots-CleverBots" target="_blank">Repl.it VPS</a></u>	
                ...
                this.addOptions(["showStats", "showStatsMass", "showStatsESTE", "showStatsEMTE", "showStatsMTE", "showStatsSTE", "showStatsTTE", "showStatsPTE", "showStatsN16", "showStatsFPS", "showTime","showbotStats"], "statsGroup");
...
function setGUIEvents() {
	...
	window.userBots.nick = $('#nick').val();
	//console.log('window.userBots.nick');
	...
	document.getElementById('openmenu').addEventListener('click', () => {//window.userBots.isAlive = true
	...
	document.getElementById('connectBots2').addEventListener('click', () => {
        if (!window.connectionBots.ws || window.connectionBots.ws.readyState !== WebSocket.OPEN) window.connectionBots.connect()
	...
	document.getElementById('stopBots2').addEventListener('click', () => {
        if (window.userBots.startedBots) window.connectionBots.send(new Uint8Array([1]).buffer)
    })
